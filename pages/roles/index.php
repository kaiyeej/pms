    ...
    <div class="section-body">
        <div class="alert alert-light alert-has-icon" style="background:#DEFCF9;border: 1px dashed #3C84AB;">
            ...
            <div class="alert-body">
                <div class="alert-title">Roles</div>
                Manage roles here.
            </div>
            <div>
        ...
        $("#dt_entries").DataTable({
            ...
            "columns": [{
                    "mRender": function(data, type, row) {
                        return '<div class="custom-checkbox custom-control"><input type="checkbox" data-checkboxes="mygroup" class="custom-control-input" name="dt_id" id="checkbox-b' + row.roles_id + '" value=' + row.roles_id + '><label for="checkbox-b' + row.roles_id + '" class="custom-control-label">&nbsp;</label></div>';
                    }
                },
                {
                    "mRender": function(data, type, row) {
                        return "<center><button class='btn btn-sm btn-info' onclick='getEntryDetails(" + row.roles_id + ")'><span class='fa fa-edit'></span></button></center>";
                    }
                },
                {
                    "data": "role_name"
